...
\addKeyword{subcritical metal systems}
\addKeyword{reduced-order model}
...
<<<<<<< HEAD
	...
	\end{array}
	$
	\includegraphics[scale=0.45]{figures/groupFlux_t6ns.jpg}
=======
		\includegraphics[scale=0.45]{figures/groupFlux_t3ns.png} &
		\includegraphics[scale=0.45]{figures/groupFlux_t5ns.png} \\
	\end{array}
	$
	\includegraphics[scale=0.45]{figures/groupFlux_t6ns.png}
>>>>>>> 0eb8c4bea8cc0ebddf9ed8c898113846f1b4025a
...
\bfg[!htb] \centering
	...
	\begin{array}{c c}
<<<<<<< HEAD
		\includegraphics[scale=0.5]{figures/alpha0-3.jpg}
		\includegraphics[scale=0.5]{figures/dmd0.jpg} \\
...
\bfg[!htb] \centering
	...
	\begin{array}{c c}
<<<<<<< HEAD
		\includegraphics[scale=0.5]{figures/alpha0-2.jpg} &
		\includegraphics[scale=0.5]{figures/dmd0.jpg} \\
...
\bfg[!htb] \centering
<<<<<<< HEAD
	\includegraphics[scale=0.5]{figures/singularValueSpectrum_fis.jpg}
=======
	\includegraphics[scale=0.5]{figures/singularValueSpectrum_fis.png}
>>>>>>> 0eb8c4bea8cc0ebddf9ed8c898113846f1b4025a
...
\bfg[!htb] \centering
	...
	\begin{array}{c c}
<<<<<<< HEAD
		\includegraphics[scale=0.5]{figures/cutoffStudy_fis.jpg}
		\includegraphics[scale=0.5]{figures/rankStudy_fis.jpg}
=======
		\includegraphics[scale=0.5]{figures/cutoffStudy_fis.png}
		\includegraphics[scale=0.5]{figures/rankStudy_fis.png}
>>>>>>> 0eb8c4bea8cc0ebddf9ed8c898113846f1b4025a
	\end{array}
	$
...
\bfg[!htb] \centering
	...
	\begin{array}{c c}
<<<<<<< HEAD
		\includegraphics[scale=0.5]{figures/fissionRate_t3ns.jpg}
		\includegraphics[scale=0.5]{figures/fissionRate_t5ns.jpg}
	\end{array}
	$
	\includegraphics[scale=0.5]{figures/fissionRate_t6ns.jpg}
=======
		\includegraphics[scale=0.5]{figures/fissionRate_t3ns.png}
		\includegraphics[scale=0.5]{figures/fissionRate_t5ns.png}
	\end{array}
	$
	\includegraphics[scale=0.5]{figures/fissionRate_t6ns.png}
>>>>>>> 0eb8c4bea8cc0ebddf9ed8c898113846f1b4025a
...
\bfg[!htb] \centering
<<<<<<< HEAD
	\includegraphics[scale=0.5]{figures/fission_interp_error.jpg}
=======
...
\bfg[t] \centering
<<<<<<< HEAD
	\includegraphics[scale=0.5]{figures/fission_extrap_error.jpg}
=======
