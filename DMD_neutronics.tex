...
The DMD solution presented in this section is derived from data produced by the numerical model 
	discussed above for a 5 cm sphere over a 10 ns simulation time discretized 
	into 500 spatial cells and 30 time-steps.
...
If the snapshot series is denoted as $X$, and the DMD representation of $X$, 
	...
	by $\lVert X - X_{DMD} \rVert_F \sim \sigma_{K+1}$ (cite)
